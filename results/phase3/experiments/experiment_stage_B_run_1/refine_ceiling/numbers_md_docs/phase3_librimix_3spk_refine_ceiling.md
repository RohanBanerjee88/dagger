...
| oracle | coarse_to_fine | 150 | 43 (29%) | 34 | 0 | 0 | 0 | 0 | 0 |
| real | gated_deflation | 75 | 74 (99%) | 1 | 0 | 0 | 0 | 0 | 0 |
| real | coarse_to_fine | 150 | 51 (34%) | 33 | 0 | 0 | 0 | 0 | 0 |
...
| coarse_to_fine | 1 | 75 | -6.75 | 1.20 | 25% | 5.6 |
| coarse_to_fine | 2 | 75 | -3.11 | 0.31 | 8% | 10.2 |


## Ordering check (deepest available depth, per arm)

- `oracle` depth 2: coarse_to_fine=1.45 gated_deflation=0.24 ungated_deflation=0.24 -- ordering holds: False
- `real` depth 2: coarse_to_fine=-1.66 gated_deflation=-1.92 ungated_deflation=-1.94 -- ordering holds: True
