# Phase 3 results -- phase3_librimix_3spk_refine_oracle_audio
...
| oracle | coarse_to_fine | 150 | 150 (100%) | 0 | 0 | 0 | 0 | 0 | 0 |
| real | gated_deflation | 75 | 74 (99%) | 1 | 0 | 0 | 0 | 0 | 0 |
| real | coarse_to_fine | 150 | 150 (100%) | 0 | 0 | 0 | 0 | 0 | 0 |
...
| coarse_to_fine | 1 | 75 | -6.73 | 1.19 | 23% | 5.6 |
| coarse_to_fine | 2 | 75 | -2.92 | 0.25 | 7% | 11.6 |


## Ordering check (deepest available depth, per arm)

- `oracle` depth 2: coarse_to_fine=1.69 gated_deflation=0.24 ungated_deflation=0.24 -- ordering holds: False
- `real` depth 2: coarse_to_fine=-1.22 gated_deflation=-1.92 ungated_deflation=-1.94 -- ordering holds: True
