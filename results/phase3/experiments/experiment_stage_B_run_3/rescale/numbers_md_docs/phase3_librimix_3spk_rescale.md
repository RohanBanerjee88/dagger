# Phase 3 results -- phase3_librimix_3spk_rescale
...
| real | coarse_to_fine | 40.30 | -1.29 |
...
`V_i` rejections: **0**; `mean_variance` nonzero in **74/150** decisions, max 0.000254
...
| coarse_to_fine | 1 | 75 | -6.73 | 1.20 | 24% | 5.6 |
| coarse_to_fine | 2 | 75 | -2.98 | 0.27 | 9% | 11.2 |
...
- `real` depth 2: coarse_to_fine=-1.29 gated_deflation=-1.92 ungated_deflation=-1.94 -- ordering holds: True
